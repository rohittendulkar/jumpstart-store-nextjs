...
class CheckoutPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      "shipping[street]": "",
      "shipping[street_2]": "",
      "shipping[town_city]": "Mumbai",
      "shipping[region]": "",
      "shipping[postal_zip_code]": "400 085",
      "shipping[country]": "IN",
      "billing[name]": "",
      "billing[street]": "",
      "billing[street_2]": "",
                ...
                <form onChange={this.handleChangeForm} onSubmit={this.captureOrder}>
                  ...
                  <div className="mb-5">
                    ...
                    >
                      ...
                      />
                      <p>
                        Receive our news, restocking, good plans and news in your mailbox! Rest
